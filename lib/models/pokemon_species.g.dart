...
_$_PokemonSpecies _$$_PokemonSpeciesFromJson(Map<String, dynamic> json) =>
    _$_PokemonSpecies(
      ...
      flavorTextEntries: (json['flavor_text_entry'] as List<dynamic>?)
      ...
      growthRate: json['growth_rate'] == null
          ? null
          : Color.fromJson(json['growth_rate'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$_PokemonSpeciesToJson(_$_PokemonSpecies instance) =>
    <String, dynamic>{
      ...
      'flavor_text_entry': instance.flavorTextEntries,
...
_$_PalParkEncounter _$$_PalParkEncounterFromJson(Map<String, dynamic> json) =>
    _$_PalParkEncounter(
      area: json['area'] == null
          ? null
          : Color.fromJson(json['area'] as Map<String, dynamic>),
...
_$_PokedexNumber _$$_PokedexNumberFromJson(Map<String, dynamic> json) =>
    _$_PokedexNumber(
      ...
      pokedex: json['pokedex'] == null
          ? null
          : Color.fromJson(json['pokedex'] as Map<String, dynamic>),
    );
...
_$_Variety _$$_VarietyFromJson(Map<String, dynamic> json) => _$_Variety(
      ...
      pokemon: json['pokemon'] == null
          ? null
          : Color.fromJson(json['pokemon'] as Map<String, dynamic>),
    );
